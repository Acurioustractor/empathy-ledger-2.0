    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl mb-6" style={{ color: 'var(--color-storm)' }}>
            Help us understand how to best honor your participation and respect
            your cultural protocols.
          </p>
          ...
          <div className="flex justify-center space-x-2 mb-8">
            {[1, 2, 3, 4].map(num => (
              <div
                ...
                style={{
                  backgroundColor:
                    num <= step ? 'var(--primary)' : 'var(--color-elder)',
                }}
              />
            ))}
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs mt-1 text-muted-foreground">
                  This can be your traditional name, chosen name, or how you'd
                  like to be known in the community.
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleInputChange('preferred_pronouns', e.target.value)
                  }
                  className="w-full"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e =>
                    handleInputChange('community_affiliation', e.target.value)
                  }
                  className="w-full"
                  required
                >
                ...
                <p className="text-xs mt-1 text-muted-foreground">
                  This helps us connect you with relevant community insights and
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {COMMON_LANGUAGES.map(language => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={profileData.languages_spoken.includes(
                          language
                        )}
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              >
                ...
                >
                  These settings help us respect your cultural protocols and
                  ensure your stories are shared appropriately.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={
                      profileData.cultural_protocols.seasonal_restrictions
                    }
                    onChange={e =>
                      handleNestedChange(
                        'cultural_protocols',
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Some of my stories may have seasonal restrictions or
                      require special ceremonial considerations.
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Some of my stories contain knowledge that should only be
                      shared with specific gender groups.
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={
                      profileData.cultural_protocols.requires_elder_review
                    }
                    onChange={e =>
                      handleNestedChange(
                        'cultural_protocols',
                  ...
                  <div>
                    <span className="font-medium">
                      Elder or Community Review
                    </span>
                    <p className="text-sm text-muted-foreground">
                      I would prefer community elders or leaders to review my
                      stories before public sharing.
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Some of my stories may contain sacred knowledge that
          ...
          {step === 4 && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive important updates about platform features and
                      community news.
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={
                      profileData.contact_preferences.community_newsletter
                    }
                    onChange={e =>
                      handleNestedChange(
                        'contact_preferences',
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Monthly newsletter with community insights, stories, and
                      collective wisdom.
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Notifications when your stories connect with others or
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={
                      profileData.contact_preferences.value_notifications
                    }
                    onChange={e =>
                      handleNestedChange(
                        'contact_preferences',
                  ...
                  <div>
                    <span className="font-medium">
                      Value Creation Notifications
                    </span>
                    <p className="text-sm text-muted-foreground">
                      Alerts when your stories help secure grants, influence
                      policy, or create other community value.
                    </p>
                  </div>
                </label>
              </div>
              ...
              <div
                className="p-4 rounded-lg"
                style={{
                  backgroundColor: 'var(--color-sunrise)',
                  opacity: 0.1,
                }}
              >
                <p
          ...
          <div className="flex justify-between mt-8">
            ...
            {step < 4 ? (
              <button
                ...
                disabled={
                  step === 1 &&
                  (!profileData.full_name || !profileData.community_affiliation)
                }
