  ...
  try {
    ...
    return [
      ...
      },
      {
        ...
        trend: 'stable',
        description:
          'Organizations using the platform for community engagement',
        category: 'communities',
        lastUpdated: 'Just now',
        privacyLevel: 'aggregate',
      },
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div
                  className={`w-12 h-12 bg-${categoryColor}-100 rounded-xl flex items-center justify-center`}
                >
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm">
                All insights are generated using privacy-preserving techniques.
                Individual stories remain encrypted and anonymous. Aggregate
                data requires minimum 1000+ stories for display.
              </p>
            </div>
          </div>
        </div>
