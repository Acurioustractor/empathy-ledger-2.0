...
export function EmbedWidget({
  ...
  const getThemeStyles = () => {
    const primary_color =
      data.project.branding_config?.primary_color || '#B85C38';
    const secondary_color =
      data.project.branding_config?.secondary_color || '#7A9B76';
    ...
    return (
      ...
      >
        ...
        <p className="text-sm opacity-75">
          No public stories are currently available for embedding from this
          project.
        </p>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs opacity-60">Powered by Empathy Ledger</span>
      </div>
