...
const caseStudies: CaseStudy[] = [
  {
    ...
    challenge:
      "Mental health services in Brisbane were overwhelmed, with long wait times and services that didn't meet community needs. Traditional feedback mechanisms weren't capturing the full picture of community experiences.",
    solution:
      "Empathy Ledger's Story Collection Engine enabled safe, anonymous sharing of mental health experiences. The Community Insight Generator identified patterns in access barriers, service gaps, and community needs while protecting individual privacy.",
    outcomes: [
    ...
    modules: [
      'Story Collection Engine',
      'Privacy Preservation Engine',
      'Community Insight Generator',
  ...
  },
  {
    ...
    challenge:
      'Parents of children with special needs were isolated and struggling to navigate complex education systems. Individual advocacy efforts were ineffective against systemic barriers.',
    solution:
      'The Community Governance Portal enabled parents to safely share experiences and collectively identify the most critical issues. Anonymous story clustering revealed patterns that informed targeted advocacy efforts.',
    outcomes: [
  ...
  },
  {
    ...
    challenge:
      "Young people in Perth felt unheard in community planning decisions. Traditional consultation methods failed to engage youth meaningfully, leading to services and spaces that didn't meet their needs.",
    solution:
      'Using multimedia story collection tools, young people shared their visions for community spaces through video, audio, and text. The Story Galaxy visualization helped community leaders understand youth perspectives and priorities.',
    outcomes: [
  ...
  },
  {
    ...
    challenge:
      'Traditional housing research missed the lived experience of housing insecurity. Vulnerable populations were often excluded from studies due to privacy concerns and institutional barriers.',
    solution:
      'The Ethical Research Toolkit enabled a major university study while maintaining complete anonymity. Zero-knowledge proofs allowed researchers to verify insights without accessing individual stories.',
    outcomes: [
  ...
  },
  {
    ...
    subtitle:
      'Indigenous community maintains control over traditional knowledge',
    category: 'community',
    ...
    challenge:
      "An Indigenous community wanted to preserve traditional knowledge while maintaining complete cultural control. Existing digital platforms didn't respect Indigenous data sovereignty principles.",
    solution:
      'Custom implementation of Indigenous Data Protocols module ensured Elder approval workflows, cultural protocol enforcement, and community benefit sharing. All data remains under community ownership.',
    outcomes: [
...
const CaseStudyShowcase: React.FC<CaseStudyShowcaseProps> = ({
  ...
  const categories = [
    { key: 'all', name: 'All Studies', count: caseStudies.length },
    {
      key: 'healthcare',
      name: 'Healthcare',
      count: caseStudies.filter(cs => cs.category === 'healthcare').length,
    },
    {
      key: 'education',
      name: 'Education',
      count: caseStudies.filter(cs => cs.category === 'education').length,
    },
    {
      key: 'community',
      name: 'Community',
      count: caseStudies.filter(cs => cs.category === 'community').length,
    },
    {
      key: 'policy',
      name: 'Policy',
      count: caseStudies.filter(cs => cs.category === 'policy').length,
    },
    {
      key: 'research',
      name: 'Research',
      count: caseStudies.filter(cs => cs.category === 'research').length,
    },
  ];
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <blockquote className="border-l-4 border-primary-300 pl-6 py-4 bg-primary-50 rounded-r-lg">
                    ...
                    <footer className="text-sm text-gray-600">
                      <strong>{selectedCaseStudy.quote.author}</strong>
                      <br />
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {selectedCaseStudy.modules.map((module, index) => (
                        <div
                          key={index}
                          className="bg-primary-50 p-3 rounded-lg text-sm font-medium text-primary-800"
                        >
                          {module}
                        </div>
                      ))}
