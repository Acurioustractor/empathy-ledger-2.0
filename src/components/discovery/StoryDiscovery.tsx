...
export default function StoryDiscovery() {
  ...
  const [sortBy, setSortBy] = useState<'recent' | 'popular' | 'impact'>(
    'recent'
  );
    ...
    return [
      {
        ...
        content:
          'After struggling with anxiety for months, I discovered the power of peer support groups in my local community. The safe space created by others who understood my journey became a lifeline during my darkest moments...',
        category: 'healthcare',
      ...
      },
      {
        ...
        content:
          'Growing up in a low-income household, quality education seemed out of reach. But through dedicated teachers and community programs, I found pathways to learning that changed my entire trajectory...',
        category: 'education',
      ...
      },
      {
        ...
        content:
          'When rent prices skyrocketed in our neighborhood, my family faced an impossible choice. This is our story of navigating the housing market and finding creative solutions through community support...',
        category: 'housing',
        themes: [
          'housing affordability',
          'community support',
        ...
        <div className="content-container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto mb-8">
              Explore powerful stories from communities around Australia. Every
              story shared with permission to inspire change and understanding.
            </p>
          ...
          {isLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {stories.map(story => (
                <article
                  key={story.id}
                  className="bg-white border border-gray-200 rounded-3xl overflow-hidden hover-lift"
                >
                          ...
                          <div className="w-8 h-8 bg-black/50 rounded-full flex items-center justify-center">
                            ...
                            >
                              <path
                                ...
                                strokeLinejoin="round"
                                strokeWidth={2}
                                d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M9 9v6m4-6v6m4-8v8"
                              />
                            </svg>
                          </div>
                        )}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      {story.themes.slice(0, 2).map(theme => (
                        <span
                          key={theme}
                          className="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded-full font-light"
                        >
                          {theme}
                        </span>
                      ))}
        ...
        <div className="content-container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 font-light mb-8">
              Join our community of storytellers making a difference. Your
              experience could inspire change and support others facing similar
              challenges.
            </p>
