...
const CATEGORIES: {
...
}[] = [
  {
    value: 'healthcare',
    label: 'Healthcare',
    description: 'Medical care, mental health, wellness services',
  },
  {
    value: 'education',
    label: 'Education',
    description: 'Schools, learning, educational access',
  },
  {
    value: 'housing',
    label: 'Housing',
    description: 'Housing affordability, homelessness, accommodation',
  },
  {
    value: 'youth',
    label: 'Youth',
    description: 'Young people, youth services, coming of age',
  },
  {
    value: 'elder_care',
    label: 'Elder Care',
    description: 'Aged care, seniors, intergenerational support',
  },
  {
    value: 'policy',
    label: 'Policy',
    description: 'Government services, policy impact, civic engagement',
  },
  {
    value: 'community',
    label: 'Community',
    description: 'Community connections, local initiatives',
  },
  {
    value: 'environment',
    label: 'Environment',
    description: 'Environmental issues, climate impact',
  },
  {
    value: 'employment',
    label: 'Employment',
    description: 'Work, careers, economic challenges',
  },
  {
    value: 'social_services',
    label: 'Social Services',
    description: 'Support services, welfare, assistance programs',
  },
];
...
const PRIVACY_LEVELS: {
  ...
  },
  {
    value: 'community',
    label: 'Community',
    description: 'Members of your communities can see this',
  },
  {
    value: 'organization',
    label: 'Organization',
    description: 'Your organization members can see this',
  },
  {
    value: 'public',
    label: 'Public',
  ...
  const loadUserData = async () => {
    try {
      ...
      if (session.user) {
        ...
        const { communities: userCommunities } = await getUserCommunities(
          session.user.id
        );
        ...
        if (userCommunities.length === 1) {
          setFormData(prev => ({
            ...prev,
            community_id: userCommunities[0].communities.id,
          }));
        }
      }
    } catch (error) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submissionData: StorySubmission = {
        ...
        audio_file: formData.audioRecording
          ? new File([formData.audioRecording], 'recording.wav', {
              type: 'audio/wav',
            })
          : formData.audio_file,
            ...
            <div className="space-y-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
                  Share your experience in your own words. You can write, record
                  audio, or upload a video.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-3xl p-8">
                ...
                <p className="text-gray-600 font-light mb-6">
                  Record your story or upload an audio file to add a personal
                  touch.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <input
                      ...
                      accept="audio/*"
                      onChange={e =>
                        handleInputChange('audio_file', e.target.files?.[0])
                      }
                      className="hidden"
                    />
                    <button
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
                  Help others find and connect with your experience by choosing
                  the most relevant category and themes.
                </p>
              </div>
                  ...
                  {CATEGORIES.map(category => (
                    ...
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className="font-normal text-gray-900 mb-1">
                        {category.label}
                      </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
                  You have complete control over who can see your story and how
                  it can be used.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <label className="flex items-start gap-4 cursor-pointer">
                    <input
                      ...
                      onChange={e =>
                        handleInputChange('can_be_shared', e.target.checked)
                      }
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 font-light">
                        Others can share your story (with attribution) to spread
                        awareness
                      </div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start gap-4 cursor-pointer">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 font-light">
                        Researchers can include your anonymized story in studies
                  ...
                  <label className="flex items-start gap-4 cursor-pointer">
                    <input
                      ...
                      onChange={e =>
                        handleInputChange('allow_ai_analysis', e.target.checked)
                      }
                      className="mt-1 w-5 h-5 text-gray-900 rounded border-gray-300 focus:ring-gray-500"
                    />
                    <div>
                      ...
                      <div className="text-sm text-gray-600 font-light">
                        Help generate community insights through
          ...
          {currentStep === 4 && (
            <div className="space-y-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
                  Take a moment to review your story before sharing it with the
                  community.
                </p>
              </div>
                ...
                <div className="border-t border-gray-100 pt-6">
                  <div className="flex items-center justify-between text-sm text-gray-600 font-light">
                    <span>
                      ...
                      {
                        PRIVACY_LEVELS.find(
                          p => p.value === formData.privacy_level
                        )?.label
                      }
                    </span>
                    <div className="flex items-center gap-4">
              ...
              <div className="bg-blue-50 rounded-3xl p-8">
                ...
                <ul className="space-y-2 text-sm text-gray-700 font-light">
                  <li>
                    • Your story will be reviewed by community moderators before
                    being published
                  </li>
                  <li>
                    • You can edit or delete your story at any time from your
                    dashboard
                  </li>
