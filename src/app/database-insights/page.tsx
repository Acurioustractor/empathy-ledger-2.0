        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Explore community patterns through privacy-preserving database
              visualizations. See aggregated insights while individual stories
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              ...
              <SecurityBadge
                variant="privacy"
                text="Differential privacy enabled"
              />
              <SecurityBadge
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Real-time insights from our privacy-preserving database. All
                data is aggregated and anonymized to protect individual privacy
                while revealing community patterns.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Explore our Supabase database structure designed for maximum
                privacy and security. See how we protect individual stories
                while enabling community insights.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Learn how we use advanced cryptographic techniques to generate
                insights without ever accessing individual story content.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  Stories are encrypted on the user's device before
                  transmission. We never have access to the actual content, only
                  encrypted data that we cannot read.
                </p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  Mathematical noise is added to all aggregated data to prevent
                  individual identification while preserving statistical
                  accuracy for community insights.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  We can prove that patterns exist in the data without revealing
                  what those patterns are based on, using cryptographic
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700">
                Our privacy-preserving database architecture maintains high
                performance while protecting individual privacy.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto text-white">
            ...
            <p className="text-xl text-gray-300 mb-12">
              Dive deeper into privacy-preserving data exploration with our
              interactive visualization tools and Story Galaxy.
            </p>
