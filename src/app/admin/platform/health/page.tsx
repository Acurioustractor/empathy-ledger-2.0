        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p>
                This dashboard monitors our bulletproof Supabase infrastructure
                featuring: connection pooling, retry logic with exponential
                backoff, circuit breaker patterns, comprehensive error handling,
                and real-time health monitoring. Never fucking breaks.
              </p>
            </div>
          </div>
        </div>
