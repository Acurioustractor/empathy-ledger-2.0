        ...
        <div className="content-container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto mb-8">
              Your stories belong to you. Our privacy principles are built on
              Indigenous data sovereignty and your fundamental right to control
              your narrative.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="bg-white border border-gray-200 rounded-3xl p-8 hover-lift">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  You own your stories completely. We act as custodians, never
                  owners. Every piece of data belongs to you and can be exported
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 hover-lift">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  Every feature includes granular privacy controls. Share
                  publicly, with your community, or keep stories private - you
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 hover-lift">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  When your stories create value through research or insights,
                  you share in that value. Our platform operates on principles
                  of fair compensation and transparent value distribution.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 hover-lift">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  Indigenous data sovereignty principles guide our platform.
                  Stories are living entities that belong to their tellers, not
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-light">
                          Control location and age visibility
                        </p>
                      </div>
                    </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  Download a complete copy of all your data at any time. Your
                  stories, settings, and interactions in a portable format.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  Edit your stories, update your profile, and correct any
                  information. You maintain complete control over your
                  narrative.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  Request complete account deletion. Your personal data will be
                  anonymized while preserving community value.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="content-container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="mailto:privacy@empathyledger.org"
