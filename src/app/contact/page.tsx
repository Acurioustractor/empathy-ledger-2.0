          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-3xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 font-light mb-8 leading-relaxed">
                Healthcare providers, community services, advocacy groups, and local 
                government seeking to understand community needs.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-8 md:px-12">
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-12">
            <form className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <label htmlFor="organization" className="block text-base font-normal text-gray-900 mb-3">
                    Organization
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="inquiry-type" className="block text-base font-normal text-gray-900 mb-3">
                    Type of Inquiry
                  </label>
                  <select
                    id="inquiry-type"
              ...
              <div className="flex items-start gap-4">
                ...
                />
                <label htmlFor="privacy-consent" className="text-base text-gray-600 font-light leading-relaxed">
                  I consent to Empathy Ledger storing and processing this information to respond to my inquiry. 
                  I understand that my data will be handled according to your{' '}
                  <Link href="/privacy" className="text-gray-900 hover:text-gray-600 font-normal no-underline">
                    Privacy Policy
                  </Link>.
                </label>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-8 md:px-12">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-light mb-2">hello@empathyledger.org</p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-normal text-gray-900 mb-3">Location</h3>
              <p className="text-gray-600 font-light mb-2">Australia Wide</p>
              <p className="text-sm text-gray-500 font-light">All states and territories</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-normal text-gray-900 mb-3">Support</h3>
              <p className="text-gray-600 font-light mb-2">Live chat available</p>
              <p className="text-sm text-gray-500 font-light">Mon-Fri 9am-5pm AEST</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 md:py-40">
        <div className="max-w-6xl mx-auto px-8 md:px-12">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 font-light max-w-3xl mx-auto">
              The dedicated team and communities we're privileged to work with across Australia.
            </p>
          </div>
      ...
      <section className="py-32 md:py-40 bg-gray-50">
        <div className="max-w-4xl mx-auto px-8 md:px-12 text-center">
          ...
          <p className="text-xl text-gray-600 font-light mb-12 max-w-3xl mx-auto">
            All communications are handled with the same privacy standards as our platform. 
            Your contact information is encrypted and used only to respond to your inquiry.
          </p>
