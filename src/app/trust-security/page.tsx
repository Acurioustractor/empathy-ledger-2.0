  ...
  const securityPrinciples = [
    {
      ...
      description: 'Every feature is built with privacy as the foundation, not an afterthought. Your data protection is embedded in our DNA.'
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'You own your story. Change permissions, download your data, or delete everything at any time. No questions asked.'
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Your stories stay in Australia, on Australian servers, under Australian privacy laws. We respect data sovereignty principles.'
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'We openly share how we handle your data. Our privacy policy is written in plain language, not legal jargon.'
    }
  ];

  const technicalSafeguards = [
    { feature: 'End-to-end encryption', description: 'Stories encrypted in transit and at rest' },
    { feature: '256-bit AES encryption', description: 'Bank-level security standards' },
    { feature: 'ISO 27001 compliant', description: 'International security certification' },
    { feature: 'Regular security audits', description: 'Third-party penetration testing' },
    { feature: 'GDPR & Privacy Act compliant', description: 'Meeting global privacy standards' },
    { feature: 'Zero-knowledge architecture', description: 'We can\'t read your private stories' }
  ];
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
              Your stories are precious. We protect them with the same care and respect 
              we'd want for our own. Every security decision is made with your privacy 
              and dignity at the forefront.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Industry-leading security measures protect your stories at every level
              </p>
            </div>
            ...
            <div className="mt-12 bg-blue-50 rounded-xl p-8 text-center">
              ...
              <p className="text-blue-800 mb-6 max-w-2xl mx-auto">
                ...
                We publish our security reports annually for complete transparency.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                You have complete control over your information. These rights are 
                guaranteed and can be exercised at any time.
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 mb-4">
                Exercise your rights through your account settings or contact our privacy team
              </p>
            ...
            <Card variant="trust" className="p-10">
              <div className="text-center">
                ...
                <div className="prose prose-lg text-gray-700 mx-auto text-left">
                  ...
                  <p className="mb-6">
                    This commitment is more than policy—it's our promise to every 
                    person who trusts us with their story.
                  </p>
                </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our security team is here to help. Whether you have questions about 
              our practices or need assistance with privacy settings, we're just a message away.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <div className="bg-white rounded-lg p-6 text-center">
                ...
                <a href="mailto:security@empathyledger.org" className="text-primary-600 hover:text-primary-700">
