      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto font-light leading-relaxed">
            Explore community insights through privacy-preserving visualizations
            that reveal patterns without compromising individual privacy
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <SecurityBadge
              variant="privacy"
              text="Individual privacy protected"
              className="backdrop-blur-sm bg-white/10"
            />
            <SecurityBadge
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              Our visualizations use advanced cryptographic techniques to show
              community patterns while ensuring individual stories remain
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-8 rounded-2xl">
              ...
              <p className="text-gray-700">
                We can verify patterns exist without seeing individual data.
                Like proving you know a secret without revealing what it is.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-coral-50 to-coral-100 p-8 rounded-2xl">
              ...
              <p className="text-gray-700">
                Mathematical noise ensures that no individual can be identified
                from aggregate data, even with sophisticated attacks.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-8 rounded-2xl">
              ...
              <p className="text-gray-700">
                Perform computations on encrypted data without ever decrypting
                it. See the results, never the individual inputs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Real-time visualizations of community patterns, updated as new
              stories are shared
            </p>
          </div>
                  ...
                  <div className="text-center">
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="bg-coral-100 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-coral-800">
                          856
                        </div>
              ...
              <div className="relative h-64">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      Stories leading to policy changes
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Click and explore different dimensions of community data while
              maintaining privacy
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Navigate through interconnected stories as galaxies of related
                  experiences. Zoom in to see themes, zoom out to see the big
                  picture.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center p-4 bg-coral-50 rounded-xl">
                  ...
                  <span className="font-medium text-gray-900">
                    Filter by themes, location, time
                  </span>
                </div>
                ...
                <div className="absolute inset-8 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="font-semibold text-xl">
                      Interactive Galaxy Demo
                    </p>
                    <p className="text-white/70 mt-2">
                      15,247 stories, 342 insights
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-12 leading-relaxed">
              Our visualizations come with mathematically provable privacy
              guarantees. Here's exactly what we can and cannot see.
            </p>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Dive into interactive visualizations that respect privacy while
