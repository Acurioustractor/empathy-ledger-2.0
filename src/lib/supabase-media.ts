...
export async function getRandomMedia(count: number = 1, type?: 'image' | 'video'): Promise<MediaItem[]> {
  try {
    let query = supabase
      .from('media')
      .select('*')
...
export async function getMediaByCategory(category: string, limit: number = 10): Promise<MediaItem[]> {
  try {
...
export async function uploadMedia(file: File, metadata: Partial<MediaItem>): Promise<MediaItem | null> {
  try {
...
export const placeholderImages = {
  ...
  community: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1920&q=80',
  ...
  impact: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=1920&q=80',
  team: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1920&q=80',
  story: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1920&q=80'
};
