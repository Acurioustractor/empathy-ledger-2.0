...
async function createTestData() {
  ...
  const { data: org } = await supabase
    ...
    .insert({
      ...
      description: 'Supporting diverse communities across Melbourne through storytelling and advocacy',
  ...
  if (org) {
    ...
    await supabase
      ...
      .insert({
        ...
        description: 'A safe space for families in inner Melbourne to share experiences and support each other',
...
async function verifySetup() {
  ...
  const tables = ['profiles', 'organizations', 'communities', 'stories', 'community_members'];
