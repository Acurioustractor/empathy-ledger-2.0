#!/usr/bin/env tsx
/**
 * MIGRATE ALL 210 STORYTELLERS - FINAL VERSION
 * We found them! Now let's migrate them all properly.
 */
...
async function validateFinalResults(): Promise<void> {
  ...
  if (totalStorytellers >= 210) {
    ...
    console.log(`\n⚠️  Partial migration: ${totalStorytellers}/210 storytellers migrated`);
  }
}

async function main(): Promise<void> {
  console.log('🎯 FINAL MIGRATION: ALL 210 STORYTELLERS');
  console.log('=========================================');
  console.log('We found all 210 storytellers across different views!');
  console.log('Now migrating them all with transcripts and profile images.');
  console.log('');
