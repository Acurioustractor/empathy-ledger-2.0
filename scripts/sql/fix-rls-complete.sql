-- =====================================================
-- CRITICAL: FIX RLS INFINITE RECURSION - COMPLETE
-- Drops existing policies by name to avoid conflicts
-- =====================================================

-- Drop all existing policies (including the ones we're about to create)
...
SELECT 'RLS policies fixed successfully! Stories should now display on website.' as message;